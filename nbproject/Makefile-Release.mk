...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lfr-ablaufsteuerung: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lfr-ablaufsteuerung ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/ElementDo.o: ElementDo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ElementDo.o ElementDo.cpp

${OBJECTDIR}/Farbe.o: Farbe.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Farbe.o Farbe.cpp

${OBJECTDIR}/LetFreedomRing_Element.o: LetFreedomRing_Element.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LetFreedomRing_Element.o LetFreedomRing_Element.cpp
